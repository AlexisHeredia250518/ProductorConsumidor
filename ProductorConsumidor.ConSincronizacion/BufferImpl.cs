        ...
        { 
            get 
            {
                ...
                if (_conteoBufferOcupado == 0) 
                {
                    ...
                    MostrarEstado($"Buffer vacío. {Thread.CurrentThread.Name} en espera."); Monitor.Wait(this); 
                } 
            ...
            { 
                ...
                { 
                    ...
                    MostrarEstado($"Buffer lleno. {Thread.CurrentThread.Name} en espera."); Monitor.Wait(this); 
                } 
                _buffer = value;
                _conteoBufferOcupado++; 
